...
The 5-fold cross validation (sensu Boyce et al 2002) provided a mean Spearman's Rank corerltion of `r rs.mean`, P = `r rs.p$p.value`, < 0.01. The model is pretty good. 
