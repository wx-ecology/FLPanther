...
## get rid of ENP 
data <- data %>% filter(!Den_ID %in% (c("FP061", "FP095A", "FP094", "FP095B")))
...
## STEP 4 RESULT - KEEP mod 2 (no Ave_Wet)
lrtest(cand.models.2[[2]], cand.models.2[[4]])
## mod 4 and mod 2 are very close to each other. take 2
